...
def mine_block():
    ...
    blockchain.add_transactions( sender = node_address, receiver = 'victor', amount = 10) 
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message' : 'This nodes had different chains so the chain was replaced by the longest one!',
